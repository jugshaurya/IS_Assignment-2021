## GOAL : 
# - Write a program that can perform a letter frequency attack on any monoalphabetic substitution cipher without human intervention. 
...
# Letter frequency Attack on monoalphabetic Substition Cipher
class LFA_ON_MASC : 
    ...
    def LFA(self, no_of_predictions = 10):
        ...
        for prediction in range(no_of_predictions):
            ...
            shift = self.getAscii(LFA_ON_MASC.DECIPHER_STRING[prediction])  - idx
...
def main():
    ...
    outputs = LFA_ON_MASC(cipher).LFA()
    print(*outputs, sep="\n")
